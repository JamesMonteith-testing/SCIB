...
const PDF_SRC = "/evidence/SCIB-CC-1991-022/E-06/E-06_Evidence_Sheet.pdf";
const PHOTO_SRC = "/evidence/SCIB-CC-1991-022/E-06/maintenance-console-printout.png";
        ...
        <header className="flex items-center justify-between gap-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-semibold">Evidence Item E-06</h1>
              <p className="text-sm text-slate-300">Maintenance Console Printout • Control Room Output</p>
            </div>
          </div>
        ...
        <section className="space-y-4">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/30 p-6 space-y-2">
            ...
            <div className="text-sm text-slate-200">
              Ref: <span className="font-mono">E-06</span> • Collected: <span className="font-mono">03/05/91 04:55</span>
            </div>
            <div className="text-sm text-slate-200">
              Item: Printed maintenance console output. Retrieved from Main Control Room area. Content relates to switchboard
              routing status and an associated access authorisation request.
            </div>
          </div>
          ...
          <Panel title="Evidence Photo">
            <div className="rounded-xl border border-slate-800 bg-slate-950/30 overflow-hidden">
              <Image src={PHOTO_SRC} alt="E-06 Photo — Maintenance Console Printout" width={1200} height={900} className="w-full h-auto" priority />
            </div>
            <div className="text-xs text-slate-500">Exhibit photo: maintenance console printout retained as recovered.</div>
          </Panel>
