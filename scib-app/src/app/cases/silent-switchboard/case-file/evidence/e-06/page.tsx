...
export default function Page() {
  ...
  useEffect(() => {
    setOk(isUnlocked("E-06"));
    function onStorage(e: StorageEvent) {
      if (e.key === UNLOCK_STORE_KEY) setOk(isUnlocked("E-06"));
    }
        ...
        {!ok ? (
          ...
          <section className="space-y-4">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/30 p-6 space-y-2">
              ...
              <div className="text-sm text-slate-200">
                Item: Printed maintenance console output. Retrieved from Main Control Room area. Content relates to switchboard routing status and an associated access authorisation request.
              </div>
            </div>
