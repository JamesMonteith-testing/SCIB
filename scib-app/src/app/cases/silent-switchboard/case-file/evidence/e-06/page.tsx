...
export default function Page() {
  ...
  function runSequence(success: boolean, normalized: string) {
    ...
    schedule(baseAt + steps.length * 120 + 140, async () => {
      ...
      pushLine("EVIDENCE UNSEALED: E-06");
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 p-6">
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <section className="space-y-4">
            ...
            <div className="mt-2 scib-term">
              <div className="relative p-5 space-y-4">
                <div className="scib-term-text text-xs scib-term-dim">
                  CASE ACCESS TERMINAL • E-06 • MODE: AUTH
                </div>
          ...
          <Panel title="Printout (scan)">
            <div className="rounded-xl overflow-hidden border border-slate-800 bg-black">
              <Image src={PHOTO_SRC} alt="Maintenance console printout" width={1400} height={1000} className="w-full h-auto" />
            </div>
          </Panel>
              ...
              <div className="space-y-3">
                <div className="rounded-xl border border-emerald-900/50 bg-emerald-950/15 p-4">
                  ...
                  <div className="mt-2 text-sm text-slate-100 leading-relaxed">
                    The console printout includes a suppressed routing line absent from the initial photocopy:
                    <div className="mt-2 font-mono text-sm text-slate-200">
                      ROUTE B-12 // PRIORITY OVERRIDE // AUTH SOURCE: OPS DESK
                    </div>
                    <div className="mt-2 text-sm text-slate-200">
                      This directly ties the control room output to an operator-side override rather than an automatic system fault.
                    </div>
                  </div>
                </div>
              </div>
