...
export default function Page() {
  ...
  const clueText = useMemo(() => {
    return (
      <>
        Clue: a single warning phrase appears in the engineer notebook, written with unusual emphasis. Treat it as a literal keyword and submit
        the phrase exactly via the terminal below.
      </>
    );
  }, []);
        ...
        <header className="flex items-center justify-between gap-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-semibold">Evidence Item E-04</h1>
              <p className="text-sm text-slate-300">Engineer Notebook Page • Intake Property</p>
            </div>
          </div>
            ...
            <div className="mt-2 scib-term">
              <div className="relative p-5 space-y-4">
                <div className="scib-term-text text-xs scib-term-dim">
                  CASE ACCESS TERMINAL • E-04 • MODE: AUTH
                </div>
                ...
                <div className="scib-term-text text-xs scib-term-dim">
                  Hint: the phrase is written like a warning, not a note — use the exact wording.
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-3">
                <div className="rounded-xl border border-emerald-900/50 bg-emerald-950/15 p-4">
                  ...
                  <div className="mt-2 text-sm text-slate-100 leading-relaxed">
                    On close inspection, the notebook page contains a second notation in a different hand at the bottom margin:
                    <div className="mt-2 font-mono text-sm text-slate-200">
                      "B-12 cleared by OPS — confirm with SWITCHBOARD."
                    </div>
                    <div className="mt-2 text-sm text-slate-200">
                      This ties the warning phrase directly to the switching floor console. If someone was “clearing” B-12 via OPS authority,
                      the activity should align with access log and staff shift authorizations.
                    </div>
                  </div>
                </div>
